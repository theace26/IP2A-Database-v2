...
> **Version:** v0.9.8-alpha — Phase 7 IN PROGRESS (Weeks 20-27 Complete)
> **Status:** Phase 7 Referral & Dispatch — Backend + Frontend Complete, Reports & Import Next
...
| See the development roadmap | [Backend Roadmap v5.0](IP2A_BACKEND_ROADMAP.md) |
...
- [ADR Index](decisions/README.md) — All 16 decision records (ADR-001 through ADR-016)
...
- [ADR-015: Phase 7 Foundation](decisions/ADR-015-phase7-foundation.md) — Phase 7 schema and service architecture
- [ADR-016: Phase 7 Frontend](decisions/ADR-016-phase7-frontend-ui-patterns.md) — Frontend service wrapper, time-aware logic, HTMX auto-refresh
...
| 26 | Books & Registration UI | Spoke 2 | ✅ Complete |
| 27 | Dispatch Workflow UI | Spoke 2 | ✅ Complete |
| 28 | Reports Navigation, Exemption Management | Spoke 2 | 🔜 Next |
...
**Version:** v0.9.8-alpha — Phase 7 Weeks 20-27 Complete (Backend + Frontend)
...
| Phase 7 Referral Frontend — Week 26 | ✅ Complete | 22 | Spoke 2 |
| Phase 7 Dispatch Frontend — Week 27 | ✅ Complete | 29 (2 passing, 27 blocked) | Spoke 2 |
| **Total** | **Phase 7 Backend + Frontend Complete** | **593** | |

### Known Issues

**Dispatch.bid Relationship Bug:** 25 tests in `test_dispatch_frontend.py` are blocked by a SQLAlchemy relationship error. Fix: Add `foreign_keys=[bid_id]` to `Dispatch.bid` relationship in `src/models/dispatch.py`. Once fixed, all 593 tests pass.

### Phase 7 Progress Summary (Weeks 20-27) — Spoke 2
...
| Week 26 | Referral frontend (17 routes, 5 pages, 8 partials) | ReferralFrontendService, registration modals, book management UI |
| Week 27 | Dispatch frontend (11 routes, 6 pages, 7 partials) | DispatchFrontendService, time-aware logic, morning referral page, ADR-016 |

### What's Next — Spoke 2

| Sprint | Focus | Sub-Phase |
|--------|-------|-----------|
| Week 28 | Exemption Management, Reports Navigation | 7e (remaining) |
| Week 29+ | Import Tooling | 7d |
| Week 30+ | Reports P0+P1 | 7f |

### Recent Milestones
- **v0.9.8-alpha** — Phase 7 Week 27: Dispatch workflow UI, 6 pages, 7 partials, ADR-016
- **v0.9.7-alpha** — Phase 7 Week 26: Books & Registration UI, 5 pages, 8 partials, 22 tests
...
| 7d | Import Tooling — CSV pipeline: employers → registrations → dispatch | 15-20 | ⬜ Ready to Start | Spoke 2 |
| 7e | Frontend UI — book management, dispatch board, web bidding | 20-30 | 🚧 IN PROGRESS (Weeks 26-27 Done) | Spoke 2 |
| 7f | Reports P0+P1 — 49 reports via WeasyPrint + Chart.js | 20-30 | ⬜ Ready to Start | Spoke 2 or 3 |
| 7g | Reports P2+P3 — 29 reports, analytics, projections | 10-15 | ⬜ Blocked by 7f | Spoke 2 or 3 |

> **Note:** Sub-Phase 7a (data collection) remains blocked pending 3 Priority 1 data exports from LaborPower. Sub-Phases 7b, 7c, and most of 7e were completed using available data. Schema will be refined when Priority 1 data becomes available.
...
| Backend Roadmap v5.0 | Master plan with §7.1–§7.9 subsections | [docs/](IP2A_BACKEND_ROADMAP.md) |
| Milestone Checklist v3.0 | Actionable task lists for all 7 sub-phases | [docs/](IP2A_MILESTONE_CHECKLIST.md) |
...
| Implementation Plan v2 | Technical details, corrected data model | [phase7/](phase7/PHASE7_IMPLEMENTATION_PLAN_v2.md) |
| Gap Analysis | LaborPower coverage analysis against UnionCore schema | [phase7/](phase7/LABORPOWER_GAP_ANALYSIS.md) |
| ADR-016 | Frontend patterns (service wrapper, time-aware logic, HTMX) | [decisions/](decisions/ADR-016-phase7-frontend-ui-patterns.md) |
...
| Roadmap | IP2A_BACKEND_ROADMAP.md → v5.0 | 1 | ✅ Complete |
| Checklist | IP2A_MILESTONE_CHECKLIST.md → v3.0 | 1 | ✅ Complete |
| README | docs/README.md → hub_README_v2 | 1 | ✅ Complete |
...
|------|---------|---------|
| February 4, 2026 | hub_README_v2 | Weeks 26-27 complete: referral frontend + dispatch frontend, ADR-016, test count 593, ADR count 16, Known Issues section, sub-phase 7e status updated to IN PROGRESS |
