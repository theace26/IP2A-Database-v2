# Week 7 Session A: Dues Landing + Rates Management

**Duration:** 2-3 hours
**Goal:** Create dues landing page with stats + rates management UI

---

## Step 1: Create DuesFrontendService
...
## Step 2: Create Dues Frontend Router
...
## Step 4: Create Dues Landing Template
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="text-right">
                    {% if stats.days_until_due is not none %}
                        ...
                        <p class="text-3xl font-bold text-warning">{{ stats.days_until_due|abs }} days</p>
                        {% endif %}
                    {% endif %}
                </div>
            </div>
...
## Step 5: Create Rates List Template

Create `src/templates/dues/rates/index.html`:
...
## Step 6: Create Rates Table Partial
...
Add to `src/templates/components/sidebar.html` after the Operations menu:
...
from src.services.dues_frontend_service import DuesFrontendService
from src.db.enums import MemberClassification, DuesPaymentStatus
