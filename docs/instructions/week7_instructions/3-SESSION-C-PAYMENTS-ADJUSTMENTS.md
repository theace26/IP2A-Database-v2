...
docker-compose up -d
pytest src/tests/test_dues_frontend.py -v  # Verify Sessions A+B tests pass
```

---

## Task 1: Add Payment Methods to DuesFrontendService

Add these methods to `src/services/dues_frontend_service.py`:

```python
# Add to existing methods in DuesFrontendService class:
...
## Task 2: Add Payment and Adjustment Routes
...
## Task 3: Create Payments List Template
...
## Task 4: Create Payments Table Partial
...
## Task 5: Create Member Payment History Template
...
## Task 6: Create Adjustments List Template
...
## Task 7: Create Adjustments Table Partial
...
## Task 8: Create Adjustment Detail Template
...
## Task 9: Add Payment and Adjustment Tests
...
# 3. Filter by status/period - table should update
# 4. Click Record on a pending payment - modal should work
# 5. Navigate to /dues/adjustments - should see list
# 6. Click an adjustment - should see detail
# 7. Review a pending adjustment - approve/deny should work
