...
class TestDispatchDashboard:
    ...
    @pytest.mark.asyncio
    async def test_dashboard_renders(self, async_client: AsyncClient, auth_cookies):
...
class TestLaborRequests:
    ...
    @pytest.mark.asyncio
    async def test_requests_list_renders(self, async_client: AsyncClient, auth_cookies):
        """Requests list page renders."""
        response = await async_client.get("/dispatch/requests", cookies=auth_cookies)
        assert response.status_code == 200
        assert b"Labor Requests" in response.content

    @pytest.mark.asyncio
    async def test_requests_filter_by_status(self, async_client: AsyncClient, auth_cookies):
    ...
    @pytest.mark.asyncio
    async def test_requests_search(self, async_client: AsyncClient, auth_cookies):
    ...
    @pytest.mark.asyncio
    async def test_request_detail_404(self, async_client: AsyncClient, auth_cookies):
...
class TestMorningReferral:
    ...
    @pytest.mark.asyncio
    async def test_morning_referral_renders(self, async_client: AsyncClient, auth_cookies):
    ...
    @pytest.mark.asyncio
    async def test_morning_referral_shows_time_guards(self, async_client: AsyncClient, auth_cookies):
...
class TestActiveDispatches:
    ...
    @pytest.mark.asyncio
    async def test_active_dispatches_renders(self, async_client: AsyncClient, auth_cookies):
        """Active dispatches page renders."""
        response = await async_client.get("/dispatch/active", cookies=auth_cookies)
        assert response.status_code == 200
        assert b"Active Dispatches" in response.content

    @pytest.mark.asyncio
    async def test_active_dispatches_filter(self, async_client: AsyncClient, auth_cookies):
...
class TestDispatchQueue:
    ...
    @pytest.mark.asyncio
    async def test_queue_renders(self, async_client: AsyncClient, auth_cookies):
        """Queue page renders."""
        response = await async_client.get("/dispatch/queue", cookies=auth_cookies)
        assert response.status_code == 200
        assert b"Dispatch Queue" in response.content

    @pytest.mark.asyncio
    async def test_queue_book_filter(self, async_client: AsyncClient, auth_cookies):
...
class TestEnforcementDashboard:
    ...
    @pytest.mark.asyncio
    async def test_enforcement_renders(self, async_client: AsyncClient, auth_cookies):
...
class TestHTMXPartials:
    ...
    @pytest.mark.asyncio
    async def test_stats_partial_returns_html(self, async_client: AsyncClient, auth_cookies):
    ...
    @pytest.mark.asyncio
    async def test_activity_feed_partial(self, async_client: AsyncClient, auth_cookies):
    ...
    @pytest.mark.asyncio
    async def test_pending_requests_partial(self, async_client: AsyncClient, auth_cookies):
    ...
    @pytest.mark.asyncio
    async def test_bid_queue_partial(self, async_client: AsyncClient, auth_cookies):
    ...
    @pytest.mark.asyncio
    async def test_queue_table_partial(self, async_client: AsyncClient, auth_cookies):
...
class TestTimeContext:
    ...
    @pytest.mark.asyncio
    async def test_time_context_includes_bidding_status(self, async_client: AsyncClient, auth_cookies):
    ...
    @pytest.mark.asyncio
    async def test_cutoff_warning_shown(self, async_client: AsyncClient, auth_cookies):
...
class TestSidebarNavigation:
    ...
    @pytest.mark.asyncio
    async def test_sidebar_dispatch_links_active(self, async_client: AsyncClient, auth_cookies):
...
class TestRoleBasedAccess:
    ...
    @pytest.mark.asyncio
    async def test_staff_can_view_dashboard(self, async_client: AsyncClient, auth_cookies):
...
class TestHTMXInteractions:
    ...
    @pytest.mark.asyncio
    async def test_request_table_htmx_swap(self, async_client: AsyncClient, auth_cookies):
    ...
    @pytest.mark.asyncio
    async def test_dispatch_table_htmx_swap(self, async_client: AsyncClient, auth_cookies):
