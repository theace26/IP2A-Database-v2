...
from app.schemas.jatc_application import (
    JATCApplicationCreate,
    JATCApplicationUpdate,
    JATCApplicationRead,
)

from app.services import jatc_application_service


router = APIRouter(
    prefix="/jatc-applications",
    tags=["JATC Applications"]
)
...
def create_jatc_application(
    data: JATCApplicationCreate,
...
def get_jatc_application(
    ...
    if not app:
        raise HTTPException(
            status_code=404, detail="JATC application not found")
    return app
